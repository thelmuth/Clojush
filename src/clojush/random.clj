...
(defn random-atom
  ...
  [atom-generators {:keys [boosted-atom-generators boosted-atom-generators-probability]}]
  (let [element (if (nil? boosted-atom-generators)
                  (lrand-nth atom-generators) ; not boosted
                  (if (< (lrand) boosted-atom-generators-probability) ;boosted
                    (lrand-nth boosted-atom-generators)
  ...
  ([atom-generators  {:keys [epigenetic-markers
   ...
   (let [markers (cond->
      ...
      (zipmap markers
              (map (fn [marker]
                     (case marker
                       :instruction (random-atom atom-generators argmap)
...
(defn random-plushy-instruction
  ...
  [atom-generators {:keys [plushy-close-probability] :as argmap}]
  (let [plushy-prob (if (number? plushy-close-probability)
    ...
    (if (< (lrand) plushy-prob)
      :close
      (random-atom atom-generators argmap))))
