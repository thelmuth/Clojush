...
(def push-argmap
  (atom (sorted-map
         ...
         :use-order-lexicase-selection false
          ;; If true, uses order lexicase selection, which retains the best
          ;; :order-lexicase-retention-rate percent of the candidates at each step

         :order-lexicase-retention-rate 0.5
          ;; The minimum percent of the the candidates to retain during each step of order-lexicase.
          ;; It may retain more if there is a tie in error at the cutoff percent
