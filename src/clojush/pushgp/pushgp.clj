...
(def push-argmap
  (atom (sorted-map
          ...
          ;;----------------------------------------
          :parent-selection :lexicase ;; The parent selection method. Options include :tournament, :eliteness-based-tournament-selection, :lexicase, :elitegroup-lexicase, :uniform :leaky-lexicase
