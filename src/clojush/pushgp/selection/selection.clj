(ns clojush.pushgp.selection.selection
  (:use [clojush globals random]
        [clojush.pushgp.selection preselection tournament lexicase epsilon-lexicase
         ...
         fitness-proportionate sampled-lexicase-tournament]))

(defn select
  "Returns a selected parent."
  [pop {:keys [parent-selection print-selection-counts case-batch-size epsilon-lexicase-version
               semantic-sampled-lexicase-tournament] :as argmap}]
