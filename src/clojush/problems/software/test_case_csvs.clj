...
(defn print-examples-to-csv
  [[train test] multiple-inputs problem print-csv print-xls]
  (let [csv-log-filename (str "../ProgramSynthesisBenchmarkDataCSV/examples-" problem ".csv")
        xls-filename (str "../ProgramSynthesisBenchmarkDataCSV/examples-" problem ".xlsx")
        ...
        test-data (map (fn [[input output]]
                            (concat (if multiple-inputs
                                    ...
                                    (cond
                                      ...
                                      :else (list output))))
                          test)
        all-lines (concat train-header train-data test-header test-data)
        ]
    (when print-csv
...
(defn print-csvs-for-problems
  [problems-with-domains-and-tests print-csv print-xls]
